...
using Seiri.Application.UseCases.Person;
using Seiri.Application.UseCases.Person.Commands.Create;
using Seiri.Application.UseCases.Person.Commands.Delete;
using Seiri.Application.UseCases.Person.Commands.Update;
using Seiri.Application.UseCases.Person.Queries.GetPerson;
